...
Процедура УстановитьВидимость()
	...
	Элементы.Дата.ФорматРедактирования = ОбщегоНазначенияКлиентСервер.ПолучитьФорматРедактированияДаты(Объект.Периодичность);
...
Процедура ЗаполнитьЦенуАкции(ВидАкции)
	...
	ОткрытьФорму("Обработка.ЗагрузкаКотировокММВБ.Форма", ПараметрыФормы, Элементы.Показатели,,,, ОписаниеОповещения);
